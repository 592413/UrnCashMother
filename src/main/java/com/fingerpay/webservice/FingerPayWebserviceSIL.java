...
public class FingerPayWebserviceSIL {
	//private static final String webServiceURI = "https://api.encodigi.net.in";
	private static final String webServiceURI = "http://199.34.22.225:9087/YouCloudMiddleware/MobileReq/public";
	private static final Logger log = Logger.getLogger(FingerPayWebserviceSIL.class);
