...
<div class="page-loader-wrapper" ng-show="loader" ng-init = "loader = true">
	<div class="loader">
		<div class="preloader">
	...
	<div class="col-md-9" style="margin: 0px; padding: 0px;">
		...
		<div class="container" style="width: 97%; height: 10vh;"> 
			...
			<div class="collapse navbar-collapse" id="navbar-collapse">
				...
				<div class="col-md-3 col-xs-hidden navbar-header balanceInfo" >
					<h4>
	...
	<aside id="leftsidebar" class="sidebar">
	 <!-- Menu -->
	<div class="menu bg-indigo">
		<ul class="list">
			<li class="header bg-indigo">MAIN NAVIGATION</li>
						...
						<div class="row clearfix">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-lg-offset-3 col-md-offset-3 ">
								<center><div class="form-group form-float">
									<button type="button" class="btn btn-lg waves-effect" ng-click = "checkuserDoopme(remitter);">SUBMIT</button>
								</div></center>
							</div>
						</div>
					</div>
								...
								<form class="form-horizontal">
									<div class="row clearfix">
											...
											<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
												<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
													<div class="form-group form-float"
														...
														<div class="form-line">
															<input type="text" class="form-control" ng-model="remitter.customermobile" maxlength="10"/>
										...
										<div class="col-md-12">
											<div
												class="col-lg-4 col-md-4 col-sm-4 col-xs-4 form-control-label">
												<label for="email_address_2">Remitter Name</label>
											</div>
											<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
												<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
													<div class="form-group">
														<div class="form-group form-float" style="margin-left: 6%">
															<div class="form-line">
																<input type="text" class="form-control" ng-model="remitter.customername"/>
																<label class="form-label">Remiiter name for the wallet</label>
															</div>
														</div>
													</div>
												</div>
										...
										<div class="col-md-12">
											<div class="col-lg-offset-6 col-md-offset-6 col-sm-offset-6 col-xs-offset-6">
												<button  type="button" class="btn btn-primary m-t-15 waves-effect" ng-click="doopmeRemitterRegister(remitter);">Submit</button>
											</div>
										</div>
									</div>
								</form>
					...
					<div class="body visibility" id="sdiv2" >
								...
								<table id="" class="table table-striped">
									<thead>
										<tr style="font-size: 13px; font-weight: bold;">
											<th class="success text-center">REMITTER MOBILE NUMBER</th>
											<th class="success text-center">REMITTER ID</th>											
											
										</tr>
									</thead>
									<tbody>
										<tr>
											<td style="font-size: 15px; text-align: center;">{{remitterDetails.MOBILENO}}</td>																						
											<td style="font-size: 15px; text-align: center;">{{remitterDetails.REMID}}</td>
						...
						<div class="row clearfix" style="margin-top: 0%">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive" >
								...
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive" ng-if="benedetails.length > 0" >
									<table id="" class="table table-striped">
										<thead>
											<tr style="font-size: 13px; font-weight: bold;">
												<th class="success text-center">BENEFICIARY ID</th>
												<th class="success text-center">MOBILE NUMBER</th>											
												...
												<th class="success text-center">Validate</th>
												<th class="success text-center">Delete</th>
												<th class="success text-center">Action</th>
											</tr>
										</thead>
										<tbody>
											<tr ng-repeat="benedetails in benedetails">
												<td style="font-size: 15px; text-align: center;">{{benedetails.map.id}}</td>																						
												<td style="font-size: 15px; text-align: center;">{{benedetails.map.mobile}}</td>
												<td style="font-size: 15px; text-align: center;">{{benedetails.map.name}}</td>
												<td style="font-size: 15px; text-align: center;">{{benedetails.map.account}}</td>
												<td style="font-size: 15px; text-align: center;">{{benedetails.map.bank}}</td>
												<td style="font-size: 15px; text-align: center;">{{benedetails.map.ifsc}}</td>
												<td style="font-size: 15px; text-align: center;"><button class="btn" ng-click="doopmeValidateBeneficiary(benedetails.map);">Validate</button><br></td>
												<td style="font-size: 15px; text-align: center;"><button class="btn" ng-click="deletedoopmebene(benedetails.map);">Delete</button><br></td>
												<td style="font-size: 15px; text-align: center;"><button class="btn" ng-click="doopmePaymentdetails(benedetails.map);">Payment</button><br><h5> Upto &#x20B9; 20,000/-</h5></td>
											</tr>
										</tbody>
									</table>
								</div>								
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive" >
								...
								<form class="form-horizontal">
									<div class="row clearfix">
										...
										<div class="col-md-12">
											<div class="col-lg-offset-6 col-md-offset-6 col-sm-offset-6 col-xs-offset-6">
												<button type="button" class="btn btn-primary m-t-15 waves-effect" ng-click = "doopmeNewBeneficiary(bene);">Submit</button>
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive" >
								...
								<form class="form-horizontal">
									<div class="row clearfix">
										...
										<div class="col-md-12">
											<div class="col-lg-offset-6 col-md-offset-6 col-sm-offset-6 col-xs-offset-6">
												<button type="button" class="btn btn-primary m-t-15 waves-effect" ng-click = "doopmeVerifyBeneficiary(beneDetails);">Submit</button>
												<button type="button" onclick="sshowDiv('sdiv2')" class="btn btn-primary m-t-15 waves-effect">Cancel</button>
											</div>
										</div>
									</div>
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive" >
								...
								<form class="form-horizontal">
									<div class="row clearfix">
										...
										<div class="col-md-12">
											<div class="col-lg-offset-6 col-md-offset-6 col-sm-offset-6 col-xs-offset-6">
												<button type="button" ng-click="doopmeMoneytransfer(bundlepayDetails);" class="btn btn-primary m-t-15 waves-effect" >Submit</button>
