                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-2 room_rl">
                                ...
                                <input type="text" class="form-control" name="" data-toggle="collapse" data-target="#RoomGuests2">
					            <!-- Room Guests -->
					            <div class="collapse abs_mnu" id="RoomGuests2">
                                    <div class="card">
                                       
                                       <div id="room_c_1" style="display: block;" class="ad_rm">
                                           <span class="r_txt">Room 1 :</span>
                                               <div class="row">
                                                   ...
                                                   <div class="col-md-5 mb-10">
                                                       <ul class="pls_mns">
                                                           <li id="minus2">-</li>
                                                           <li><input class="val_f" type="text" name="" id="value2" value="2" ng-model="hotelsearch.adultno1" ng-init="hotelsearch.adultno1=2"/></li>
                                                           <li id="plus2">+</li>
                                                       </ul>
                                                   </div>
                                               </div>
                                               <div class="row">
                                                   ...
                                                   <div class="col-md-5">
                                                       <ul class="pls_mns">
                                                           <li id="minus" ng-click="hotelsearch.childno1 = hotelsearch.childno1 - 1;" ng-min="0">-</li>
                                                           <li><input class="val_f" type="text" name="" id="value" value="0"  ng-model="hotelsearch.childno1" ng-init="hotelsearch.childno1=0" /></li>
                                                           <li id="plus" ng-click="hotelsearch.childno1 = hotelsearch.childno1 + 1;" ng-max="2">+</li>
                                                       </ul>
                                                   </div>
                                               </div>
                                        ...
                                        <div id="room_b_1" style="display: block;" class="row">
                                           <div class="col-md-5 hotel-desc mt-10">
                                               <button id="room_btna_1" class="addbtn" type="button">Add room</button>
                                           </div>
                                      ...
                                      <!-- room 2 -->
                                        <div id="room_c_2" style="display: none;" class="ad_rm">
                                           <span class="r_txt">Room 2 :</span>
                                               <div class="row">
                                                   ...
                                                   <div class="col-md-5 mb-10">
                                                       <ul class="pls_mns">
                                                           <li id="minus3" ng-click="hotelsearch.adultno2 = hotelsearch.adultno2 - 1;" ng-min="0">-</li>
                                                           <li><input class="val_f" type="text" name="" id="value3" value="0" ng-model="hotelsearch.adultno2" ng-init="hotelsearch.adultno2=0" /></li>
                                                           <li id="plus3" ng-click="hotelsearch.adultno2 = hotelsearch.adultno2 + 1;" ng-max="2">+</li>
                                                       </ul>
                                                   </div>
                                               </div>
                                               <div class="row">
                                                   ...
                                                   <div class="col-md-5">
                                                       <ul class="pls_mns">
                                                           <li id="minus_c_1" ng-click="hotelsearch.childno2 = hotelsearch.childno2 - 1;" ng-min="0">-</li>
                                                           <li><input class="val_f" type="text" name="" id="value_c_1" value="0"   ng-model="hotelsearch.childno2" ng-init="hotelsearch.childno2=0"/></li>
                                                           <li id="plus_c_1" ng-click="hotelsearch.childno2 = hotelsearch.childno2 + 1;" ng-max="2">+</li>
                                                       </ul>
                                                   </div>
                                               </div>
                                        ...
                                        <div id="room_b_2" style="display: none;" class="row">
                                           <div class="col-md-5 hotel-desc mt-10">
                                               <button id="room_btna_2" class="addbtn" type="button">Add room</button>
                                           </div>
                                           <div class="col-md-4 hotel-desc mt-10">
                                              <div class="row">
                                                <button id="room_btnr_2" class="addbtn_rd" type="button">Remove</button>
                                              </div>
                                           </div>
                                           <div class="col-md-3 price_m">
                                               <div class="row">
                                      ...
                                      <!-- room 3 -->
                                        <div id="room_c_3" style="display: none;" class="ad_rm">
                                           <span class="r_txt">Room 3 :</span>
                                               <div class="row">
                                                   ...
                                                   <div class="col-md-5 mb-10">
                                                       <ul class="pls_mns">
                                                           <li id="minus4" ng-click="hotelsearch.adultno3 = hotelsearch.adultno3 - 1;" ng-min="0">-</li>
                                                           <li><input class="val_f" type="text" name="" id="value4" value="0" ng-model="hotelsearch.adultno3" ng-init="hotelsearch.adultno3=0" /></li>
                                                           <li id="plus4" ng-click="hotelsearch.adultno3 = hotelsearch.adultno3 + 1;" ng-max="2">+</li>
                                                       </ul>
                                                   </div>
                                               </div>
                                               <div class="row">
                                                   ...
                                                   <div class="col-md-5">
                                                       <ul class="pls_mns">
                                                           <li id="minus_c_2" ng-click="hotelsearch.childno3 = hotelsearch.childno3 - 1;" ng-min="0">-</li>
                                                           <li><input class="val_f" type="text" name="" id="value_c_2" value="0" ng-model="hotelsearch.childno3" ng-init="hotelsearch.childno3=0" /></li>
                                                           <li id="plus_c_2" ng-click="hotelsearch.childno3 = hotelsearch.childno3 + 1;" ng-max="2">+</li>
                                                       </ul>
                                                   </div>
                                               </div>
                                      ...
                                      <!-- room 4 -->
                                        <div id="room_c_4" style="display: none;" class="ad_rm">
                                           <span class="r_txt">Room 4 :</span>
                                               <div class="row">
                                                   ...
                                                   <div class="col-md-5 mb-10">
                                                       <ul class="pls_mns">
                                                           <li id="minus5" ng-click="hotelsearch.adultno4 = hotelsearch.adultno4 - 1;" ng-min="0">-</li>
                                                           <li><input class="val_f" type="text" name="" id="value5" value="0" ng-model="hotelsearch.adultno4" ng-init="hotelsearch.adultno4=0"/></li>
                                                           <li id="plus5" ng-click="hotelsearch.adultno4 = hotelsearch.adultno4 + 1;" ng-max="2">+</li>
                                                       </ul>
                                                   </div>
                                               </div>
                                               <div class="row">
                                                   ...
                                                   <div class="col-md-5">
                                                       <ul class="pls_mns">
                                                           <li id="minus_c_3" ng-click="hotelsearch.childno4 = hotelsearch.childno4 - 1;" ng-min="0">-</li>
                                                           <li><input class="val_f" type="text" name="" id="value_c_3" value="0" ng-model="hotelsearch.childno4" ng-init="hotelsearch.childno4=0" /></li>
                                                           <li id="plus_c_3" ng-click="hotelsearch.childno4 = hotelsearch.childno4 + 1;" ng-max="2">+</li>
                                                       </ul>
                                                   </div>
                                               </div>
