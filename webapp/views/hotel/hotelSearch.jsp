...
.hotel_box{
    ...
    box-shadow: 0px 4px 12px 7px #ccc;
    float: left;
    width: 100%;
}
.hotel_box h3{
        ...
        <div class="container-fluid">
            ...
            <div id="navbar1" class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right nav-list">
                    <li><a onClick="showDiv('modisearch')">Hotel Search</a></li>
                    <li><a href="#">Booking Queues</a></li>
                    <li><a  onClick="showDiv('div4')">Tickets Queues</a></li>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-2 room_rl">
                                <label>{{hotelsearch.rooms}} Rooms & Guests</label>
                                <input type="text" class="form-control" name="" data-toggle="collapse" data-target="#RoomGuests2" ng-value="hotelsearch.rooms">
					            <!-- Room Guests -->
					            <div class="collapse abs_mnu" id="RoomGuests2">
                                    <div class="card">
                                       ...
                                       <div id="room_c_1" style="display: block;" class="ad_rm" ng-show="hotelsearch.rooms>0">
                                           <span class="r_txt">Room 1 :</span>
                                               <div class="row">
                                                   ...
                                                   <div class="col-md-5 mb-10">
                                                       <ul class="pls_mns">
                                                           <li ng-if="hotelsearch.adultno1 === 1">-</li>
                                                           <li ng-if="hotelsearch.adultno1 > 1" ng-click="hotelsearch.adultno1 = hotelsearch.adultno1 - 1;">-</li>
                                        ...
                                        <div id="room_b_1" style="display: block;" class="row" ng-show="hotelsearch.rooms == 1">
                                           <div class="col-md-5 hotel-desc mt-10">
                                               <button id="room_btna_1" class="addbtn" type="button" ng-click="roomadd(hotelsearch);">Add room</button>
                                           </div>
                                      ...
                                      <!-- room 2 -->
                                        ...
                                        <div id="room_b_2"class="row" ng-show="hotelsearch.rooms == 2">
                                           <div class="col-md-5 hotel-desc mt-10">
                                               <button id="room_btna_2" class="addbtn" type="button" ng-click="roomadd(hotelsearch);">Add room</button>
                                           </div>
                                           <div class="col-md-4 hotel-desc mt-10">
                                              <div class="row">
                                                <button id="room_btnr_2" class="addbtn_rd" type="button" ng-click="roomremove(hotelsearch);">Remove</button>
                                              </div>
                                           </div>
                                           <div class="col-md-3 price_m">
                                               <div class="row">
                                      ...
                                      <!-- room 3 -->
                                        ...
                                        <div id="room_b_3" class="row" ng-show="hotelsearch.rooms == 3">
                                           <div class="col-md-5 hotel-desc mt-10">
                                               <button id="room_btna_3" class="addbtn" type="button" ng-click="roomadd(hotelsearch);">Add room</button>
                                           </div>
                                           <div class="col-md-4 hotel-desc mt-10">
                                              <div class="row">
                                                <button id="room_btnr_3" class="addbtn_rd" type="button" ng-click="roomremove(hotelsearch);">Remove</button>
                                              </div>
                                           </div>
                                           <div class="col-md-3 price_m">
                                               <div class="row">
                                      ...
                                      <!-- room 4 -->
                                        ...
                                        <div id="room_b_4" class="row" ng-show="hotelsearch.rooms == 4">
                                           <div class="col-md-5 hotel-desc mt-10">
                                               <button id="room_btnr_4" class="addbtn_rd" type="button" ng-click="roomremove(hotelsearch);">Remove</button>
                                           </div>
                                           <div class="col-md-4 hotel-desc mt-10">
                                              <div class="row">
                ...
                <div class="hotel-booking-list" ng-repeat="hotelresult in hotelList">
                    <div class="hotel-list-view">
                        <div class="wrapper">
                            ...
                            <div class="col-md-5 col-sm-12 hotel-info">
                                <div>
                                    <div class="hotel-header">
                                        <h5>{{hotelresult.HotelName}}
                                        <div star-rating rating-value="hotelresult.StarRating" max="5"></div>
                            ...
                            <div class="col-md-3 col-sm-12">
                               <div class="price_m text-center">
                                    <h3><i class="fa fa-rupee-sign icn-col"></i>{{hotelresult.HotelPrice.totalprice+hotelresult.adminmarkup+hotelresult.usermarkup+hotelresult.commission|number:2}}</h3>
                                    <p>Per Night</p>
                                    <a ng-click="searchHotalDetails(hotelresult);">Select Room</a><br>{{hotelresult.StarRating}}/5.0
                               </div>
                            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-1 col-sm-12">
                <ul class="pr_bc">
                    <li>
                        <a class="back_fixd" onClick="showDiv('div1')" href="#">Back</a>
                    </li>
                </ul>
            </div>
        </div>
                                  ...
                                  <table class="table table-bordered table-hover ">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{hoteldetailsresult.HotelRoomsDetail | totalCommission:'customRoomPrice'|number:2}}</td>
                                            </tr>
                                       <!--      <tr>
                                            ...
                                            <tr>
                                                <td>Total</td>
                                                <td>{{hoteldetailsresult.HotelRoomsDetail | totalCommission:'customtotal'|number:2}}</td>
                                            </tr> 
                                        </tbody>
                                    </table>
                                    <div class="hotel-desc">
                                    ...
                                    <tr ng-repeat="cand in hoteldetailsresult.HotelRoomsDetail[0].CancellationDetail">
                                    <td>.</td>
                                    <td>{{cand.FromDate}}</td>
                                    <td>{{cand.ToDate}}</td>
                                    <td>{{cand.Charge}}</td>
<!--                                     <td>{{cand.ChargeType}}</td> -->
                                    <td>{{cand.Currency}}</td>
                                    </tr></table>
                                        <a href="#"  data-toggle="modal" data-target="#cancelationModal" ng-click="canceldt(hoteldetailsresult.HotelRoomsDetail[0].CancellationPolicies);">cancellationPolicy</a>
                                    </div>
                              </div>
                              <div class="col-md-4">
...
<!-- select roome End -->
<div class="modal fade" id="cancelationModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h3 class="modal-title" id="lineModalLabel">Cancelation</h3>
					</div>
...
<div class="modal fade" id="cencellpol" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	...
	<div id="div4" class="clearfix"  style="display: none;">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="cardgf">
								...
								<form class="form-horizontal">
									<div class="clearfix">
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
											<div class="form-groupfsdd">
											<label for="email_address_2">Start Date</label>
												<div class="form-line">
													<input type="text" class="form-control" id="dp5" ng-model="queue.start_date" placeholder="Enter Start Date" readonly="readonly" />
												</div>
											</div>
										</div>
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
											<div class="form-groupfsd">
											<label for="email_address_2">End Date</label>
												<div class="form-line">
													<input type="text" class="form-control" id="dp6"  ng-model="queue.end_date"  placeholder="Enter End Date" readonly="readonly" />
												</div>
											</div>
										</div>
									</div>
									<div class="clearfix">
										...
										<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
											<div class="col-md-offset-3">
												<button style="margin-top: 15px;" type="button" ng-click="hotelticketqueue(queue)" class="btn btn-primary waves-effect" >Update</button>
											</div>
										</div>
									</div>
								</form>
				...
				<div class="row clearfix" id="sdiv6" style="display: none;">
					<div class="form-group">
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
							<div class="panel panel-default panel-table m-b-0">
								<div class="cardfsdf m-b-0 p-b-20">
								<div class="header">
									<h2 style="margin-left: 15px;">Ticket Queue Details</span></h2>
								</div>
								
							<!-- -------------------------------- Booking Cardes ------------------------------------ -->	
								<div class="paneldd panel-defaultsc m-b-0  m-l-10 m-r-10 m-t-20 m-b-20" ng-repeat="ticket in hotelbookinglist"  >
								<div class="cardsad m-b-0">
									<div class="row border-bottom m-l-10 m-r-10">
										<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8 p-t-10 p-b-0 m-b-0">
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 m-b-0 p-t-10 p-b-10 border-bottom">
												<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 p-t-0 p-b-0 m-b-0 m-t-0">
													<h5 > {{ticket.hotelpassenger.name}}</h5>
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p-t-0 p-b-0 m-b-0 m-t-0 bg-lime ">
												<span class="lead font-20">Booked On :</span> <span class="lead font-15 p-l-20">{{ticket.booking_date}}  {{ticket.booking_time}}</span>
											</div>
										</div>
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 p-t-10 p-b-10 p-l-0 p-r-10 m-b-0">
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p-t-10 p-b-10 m-b-0">
												<div class="panel panel-default panel-table m-b-0">
													<div class="cardff m-b-0 p-t-10 p-b-10 p-l-10 p-r-10 bg-lime">
														...
														<div class="row m-l-0 m-r-0">
															<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 p-t-10 p-b-10 m-b-0 text-right">
																<h5 class="m-b-10">Booking Id:</h5>
																<h5 class="m-b-10">Hotel Name:</h5>
																<h5 class="m-b-10">Check In:</h5>
																<h5 class="m-b-10">Check Out:</h5>
															</div>
															<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 p-t-10 p-b-10 m-b-0 text-left">
																<h5 class="m-l-10">{{ticket.booking_id}}</h5>
																<h5 class="m-l-10">{{ticket.hotelname}}</h5>
																<h5 class="m-l-10">{{ticket.check_in}}</h5>
																<h5 class="m-l-10">{{ticket.check_out}}</h5>
															</div>
														</div>
													</div>
												</div>
									...
									<div class="clearfix">
										<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
											...
											<button type="button" class="btn btn-info mr-10" ng-click="viewTicket(ticket)">view ticket</button>
											<button type="button" class="btn btn-info" ng-click="cancelHotel(ticket)">Change Request</button>
				        ...
				        <div class="hotel_box">
				            <div class="row">
				              ...
				              <div class="col-md-6 text-right">
				                <h3><i class="fas fa-bed"></i> Hotel Confirmation Voucher</h3>
				              </div>
				            </div>
				            <hr>
				            <div class="row">
				              <div class="col-md-6">
				                <h3 class="gust">Guest Name : <strong> {{viewhotelticket.hotelpassenger[0].name}}</strong> </h3>
				              </div>
				            </div>
				            <hr>
				            ...
				            <div class="row">
				              <div class="col-md-6">
				                <h3 class="gust_ofr"><strong>{{viewhotelticket.hoteldetails.HotelName}}</strong></h3>
				                <span class="carti_g"><i class="far fa-check-circle"></i> goStays Certified</span>
				                <p class="g_add">
				                   {{viewhotelticket.hoteldetails.address}}
				                </p>
				                <p class="g_add">
				                    <span>Ph : {{viewhotelticket.hoteldetails.mobile}}</span>
				                </p>
				              </div>
				              <div class="col-md-3">
				                <h3 class="gust">Check IN : <br><strong> {{ticketdate.checkindt| date : "MMMM d, y"}} </strong> </h3>
				              </div>
				              <div class="col-md-3">
				                <h3 class="gust">Check OUT : <br><strong> {{ticketdate.checkoutdt| date : "MMMM d, y"}}</strong> </h3>
				              </div>
				            </div>
				            <hr>
				            <table class="table table-responsive">
				                <thead class="thead-dark">
				                  <tr>
				                    ...
				                    <th scope="col"></th>
				                    <th scope="col">Accommodation charges<br> collected on behalf of hotel:</th>
				                    <th scope="col">Rs. 3358</th>
				                  </tr>
				                </thead>
				                <tbody>
				                  <tr>
				                    <th scope="row">Hotel Booking ID:</th>
				                    <td>{{viewhotelticket.hoteldetails.booking_id}}</td>
				                    <td></td>
				                    <td>Rs. {{viewhotelticket.hotelmarkup.totalamount}}</td>
				                  </tr>
				                  <tr>
				                    <th scope="row">Advance Receipt Number:</th>
				                    <td>HDAR000026460661</td>
				                    <td>Convenience Fees:</td>
				                    <td>Rs. 3358</td>
				                  </tr>
				                  <tr>
				                    <th scope="row">Date of Booking:</th>
				                    <td>Sept. 12, 2018, 11:36 a.m.</td>
				                    <td>Reversal of Convenience Fees:</td>
				                    <td>Rs. 168</td>
				                  </tr>
				                  <tr>
				                    <th scope="row">Room Type:</th>
				                    <td>Deluxe AC with free WIFI with Breakfast</td>
				                    <td>Discounts / Wallet: </td>
				                    <td>Rs. 691</td>
				                  </tr>
				                  <tr>
				                    <th scope="row">Room 1:</th>
				                    <td>2 Adults / 0 Child</td>
				            ...
				            <div class="row">
				              <div class="col-md-6">
				                ...
				                <h3 class="gust_ofr"><strong>company Private Limited</strong></h3>
				                <ul>
				                    <li>Registered Office: UG-07 (front side), TDI Mall, Rajouri Garden, Delhi-110027 Ph:+91-8447113229</li>
				                    <li>Email:- info@gmail.com</li>
				                    <li>Contect NO : 71745745174</li>
				                    <li></li>
				                    <li></li>
				                    <li></li>
				                    <li></li>
