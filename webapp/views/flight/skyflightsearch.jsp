...
<body ng-app="app" ng-controller="appController">
	...
	<div id="div0">
		<div class="flight-booking-form" style="background-image: url('assets/images/f2.png');">
									...
									<div class="col-md-12">
										<ul class="nav nav-tabs">
											...
											<li><a data-toggle="tab" href="#roundmenu2{{$index}}">Baggage
													Information</a></li>
											<!-- <li><a data-toggle="tab" href="#roundmenu3{{$index}}">Cancellation
													Rules</a></li> -->
										</ul>
											...
											<div class="col-md-12">
												<ul class="nav nav-tabs">
													...
													<li><a data-toggle="tab" href="#menu2{{$index}}">Baggage
															Information</a></li>
													<!-- <li><a data-toggle="tab" href="#menu3{{$index}}">Cancellation
															Rules</a></li> -->
												</ul>
															...
															<div class="row">
																<div class="col-md-6">
																	<div class="table-responsive">
																		<table class="table table-bordered">
																			<tr>
																				<td class="text-center">Before 4 hours
																					Departure</td>
																				<td class="text-center">Rs. 3500</td>
																			</tr>
																			<tr>
												...
												<form>
													...
													<div class="form-group">
														<div class="row">
															...
															<div class="col-md-5" ng-if="result.isDomestic===false">
																<label class="passenger-form-label">PassPort:</label> <input
																	type="text"
																	class="form-control  passenger-form-control"
																	id="adultpassport{{i}}">
															</div>
...
<div id="div4" style="display: none; margin: 0px;">
		<div class="flight-list-page-search hidden-sm hidden-xs">
			<div class="container">
				<div class="row">
					<div class="flight-search-form">
							...
							<div class="flight-list-heading mt-20 mb-20">
								<div class="row flight-result-list"
									...
									<div class="col-md-12 flight-list-v2" style="padding: 0;">
										<div class="col-md-12">
											<div class="flight-list-main">
											<div  class="col-md-9" ng-repeat="flightseg in flightone.FlightSegments" ng-if="flightseg.SegmentIndicator==='1'">
												<div class="col-md-2 col-sm-2 text-center airline">
													<img
														src="assets/skyflight/images/flightIcon/{{flightone.AirlineId}}.png" style="width: 50%">
													<h6>{{flightone.AirlineName}}-{{flightseg.FlightNumber}}</h6>
												</div>
												<div class="col-md-2 col-sm-2 col-xs-4 departure text-center pt-20">
													<h3>
														<i class="fa fa-plane"></i> {{flightseg.Origin}} <span
															class="ft">({{flightseg.DepartureTime}})</span>
													</h3>
													
													<h5 class="bold">{{flightseg.DepartureDate}}</h5>
												</div>
												...
												<div class="col-md-3 col-sm-3 col-xs-4 stop-duration text-center pt-20">
													...
													<div class="stop"></div>
													<div class="stop-box">
														<span>{{flightone.stops}} Stop</span>
													</div>
													<div class="duration text-center">
														<span ng-if="flightseg.TripIndicator==='1'"><i class="fa fa-clock-o"></i>
															{{flightone.totalduration}}</span>
														<span ng-if="flightseg.TripIndicator==='2'"><i class="fa fa-clock-o"></i>
															{{flightone.totaldurationinternational}}</span>	
													</div>
												</div>
												<div class="col-md-2 col-sm-2 col-xs-4 destination text-center pt-20" ng-if="flightseg.TripIndicator==='1'">
													<h3>
														<i class="fa fa-plane"></i> {{destinationDetail[0]}} <span
															class="ft">({{flightone.FlightSegments[flightone.stops].ArrivalTime}})</span>
													</h3>
													<h5 class="bold">{{flightone.FlightSegments[flightone.stops].ArrivalDate}}</h5>
													<!-- <h5 class="bold">{{flightone.FlightSegments[0].ArrivalTime}}</h5> -->
													<!--  <h5>{{flights.FlightSegments[0].Destination}}</h5> -->
												</div>
												<div class="col-md-2 col-sm-2 col-xs-4 destination text-center pt-20" ng-if="flightseg.TripIndicator==='2'">
													<h3>
														<i class="fa fa-plane"></i> {{sourceDetail[0]}} <span
															class="ft">({{flightone.FlightSegments[flightone.internationalroundstops].ArrivalTime}})</span>
													</h3>
													<h5 class="bold">{{flightone.FlightSegments[flightone.internationalroundstops].ArrivalDate}}</h5>
													<!-- <h5 class="bold">{{flightone.FlightSegments[0].ArrivalTime}}</h5> -->
													<!--  <h5>{{flights.FlightSegments[0].Destination}}</h5> -->
												</div>
												</div>
										...
										<div class="col-md-12 col-xs-12">
											<div class="flight-list-footer">
												...
												<div class="col-md-6 col-sm-6 col-xs-12 clear-padding">
													<div class="pull-right">
														<a id="detail{{$index}}" href="javascript:"
															ng-click="showinternationalFlightDetailTabs($index);">Show Details
															+</a>
													</div>
												</div>
											</div>
									...
									<div class="col-md-12 flight-details-tab"
										id="tabDetailinter{{$index}}" style="display: none;">
										<div class="row" style="margin: 0; padding: 10px 0px 0px 0px;">
											<div class="col-md-12">
												<ul class="nav nav-tabs">
													<li class="active"><a data-toggle="tab"
														href="#homei{{$index}}">Flight Information</a></li>
													<li><a data-toggle="tab" href="#menui1{{$index}}">Fare
															Details</a></li>
													<li><a data-toggle="tab" href="#menui2{{$index}}">Baggage
															Information</a></li>
													<!-- <li><a data-toggle="tab" href="#menui3{{$index}}">Cancellation
															Rules</a></li> -->
												</ul>

												<div class="tab-content">
													<div id="homei{{$index}}" class="tab-pane fade in active">
														<div class="table-responsive">
													...
													<div id="menui1{{$index}}" class="tab-pane fade">
														<div class="table-responsive">
															<table class="table table-bordered">
																<tr>
																	<td class="text-center">Passenger</td>
													...
													<div id="menui2{{$index}}" class="tab-pane fade">
														<div class="table-responsive">
															<table class="table table-bordered">
																<tr>
																	<td class="text-center">Airline</td>
													...
													<div id="menui3{{$index}}" class="tab-pane fade">
														<div class="fare-rules">
															<div class="row">
																<div class="col-md-6">
																	<div class="table-responsive">
