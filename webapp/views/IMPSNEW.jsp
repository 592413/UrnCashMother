						...
						<div class="row clearfix">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-lg-offset-3 col-md-offset-3 ">
								<center><div class="form-group form-float">
									<button type="button" class="btn btn-lg waves-effect" ng-click = "checkuserEncore(remitter);">SUBMIT</button>
								</div></center>
							</div>
						</div>
					</div>
									...
									<div class="row clearfix">
										...
										<div class="col-md-12">
											<div class="col-lg-offset-6 col-md-offset-6 col-sm-offset-6 col-xs-offset-6">
												<button  type="button" class="btn btn-primary m-t-15 waves-effect" ng-click="encoreRemitterRegister(remitter);">Submit</button>
											</div>
										</div>
									</div>
								</form>
								...
								<table id="" class="table table-bordered table-hover">
									<thead>
										<tr style="font-size: 13px; font-weight: bold;background-color: #2196f3;">
										 ...
										 <th class="text-center" ng-if="remitterDetails.RESP_CODE==700">REMITTER VERIFY</th>											
									...
									<table id="" class="table table-bordered table-hover">
										...
										<tbody>
											<tr ng-repeat="benedetails in remitterbeneficiarylist">
											 ...
											 <td style="font-size: 15px; text-align: center;"><button class="btn" ng-click="ValidateBeneficiaryEncore(benedetails);">Validate</button><br></td>
												<!-- <td style="font-size: 15px; text-align: center;" ng-if="benedetails.otpverified==true"><h5>Validated</h5><br></td> -->
												<td style="font-size: 15px; text-align: center;"><button class="btn" ng-click="deleteBeneficiaryEncore(benedetails);">Delete</button><br></td>
										...
										<div class="row">
										 	<div class="col-md-12">
												...
												<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
													<div class="form-group">
														<div class="form-group from-bord form-float" style="margin-left: 15px;">
															<label for="email_address_2">Bank Name :<sup class="col-red">*</sup></label>
															<div class="form-line pa-from">
															<input type="text" class="form-control" ng-model="bundlepayDetails.bank" id="" readonly="readonly"/>
...
<script src="assets/js/angular.min.js"></script>
	...
	<script src="assets/scripts/angular_encoreDmr.min.js?version=1.1.0"></script>
