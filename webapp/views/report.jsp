...
<body class="{{reseller.theme}}" ng-app = "app" ng-controller = "appController">
	...
	<section class="content enco_content" style="margin: 0px;">
				...
				<div class="card">
					...
					<div class="body">
						<form class="form-horizontal">
							...
							<div class="rowfdf  m-t-20">
								<div class="col-md-4">
									<dir-pagination-controls max-size="5" direction-links="true"
										boundary-links="true"> </dir-pagination-controls>
								</div>
								<div class="col-md-4 col-lg-4 col-sm-4 col-xs-4">
									<label>Number Row To Display :</label>
								...
								<div class="col-md-4">
									...
									<input class="form-control" type="text" step="1"
										placeholder=" Enter Search Item " ng-model="Searchname">
								</div>
							</div>
								...
								<div class="row clearfix" style="margin-top: 2%">
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive" ng-if="viewBalanceRequestDetails.length > 0">
										<table id="mainTable" class="table table-striped">
											...
											<tbody>
												<tr dir-paginate="item in viewBalanceRequestDetails |filter:Searchname | itemsPerPage: rowlimit">
													<td style="font-size: 15px; text-align: center;">{{(pageSize*currentPage+1)+$index}}</td>
									...
									<div data-ng-show="viewBalanceRequestPagination" style="margin-left: 20px;">
										...
										{{currentPage+1}}/{{numberOfPages()}}
										<button ng-disabled="currentPage >= data.length/pageSize - 1" ng-click="currentPage=currentPage+1">Next</button> -->
										 <button type="button" class="btn btn-primary" ng-click="getviewBalanceRequestDetailsExcel(viewBalanceRequestDetails);" ng-if="viewBalanceRequestDetails.length > 0">Export</button>
									</div>
							...
							<div class="row clearfix" style="margin-top: 2%">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive" ng-if = "TransactioReport.length > 0">
									<table id="mainTable" class="table table-striped">
										...
										<tbody> 
											<tr	dir-paginate="TransactioReport in TransactioReport  |filter:Searchname | itemsPerPage: rowlimit" ng-if = "TransactioReport.credit != 0 || TransactioReport.debit != 0">
											<td>{{$index + 1}}</td>
						...
						<div class="row clearfix" style="margin-top: 2%">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive" ng-if = "RechargeReports.length > 0">
								<table id="mainTable" class="table table-striped">
									...
									<tbody>
										<tr dir-paginate="report in RechargeReports |filter:Searchname | itemsPerPage: rowlimit">
											<td style="font-size: 12px;">{{$index + 1}}</td>
							...
							<div class="row clearfix" style="margin-top: 2%">
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive" ng-if = "refundReportDetails.length > 0">
									<table id="mainTable" class="table table-striped">
										...
										<tbody>
											<tr	dir-paginate="item in refundReportDetails |filter:Searchname | itemsPerPage: rowlimit" ng-if = "refundReportDetails.credit != 0 || refundReportDetails.debit != 0">
											<td>{{$index + 1}}</td>
											<td>{{item.name}}</td>
											<td>{{item.adopbal}}</td>
						...
						<div class="row clearfix" style="margin-top: 2%">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive"  ng-if="viewUtilityDetails.length > 0">
								<table id="mainTable" class="table table-striped">
									...
									<tbody>
										<tr dir-paginate="utilityDetails in viewUtilityDetails |filter:Searchname | itemsPerPage: rowlimit">
								...
								<div class="row clearfix" style="margin-top: 2%">
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive" ng-if="viewBalanceTransferDetails.length > 0">
										<table id="mainTable" class="table table-striped">
											...
											<tbody>
												<tr dir-paginate="item in viewBalanceTransferDetails |filter:Searchname | itemsPerPage: rowlimit">
													<td style="font-size: 15px; text-align: center;">{{$index + 1}}</td>
				...
				<div class="card">
						...
						<div class="row clearfix visibility" id="sdiv19" style="margin-top: 2%">	
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive" ng-if = "panReports.length > 0">
								<table id="mainTable" class="table table-striped">
									...
									<tbody>
										<tr dir-paginate="report in panReports |filter:Searchname | itemsPerPage: rowlimit">
											<td style="font-size: 12px;">{{$index + 1}}</td>
						 	...
						 	<div data-ng-show="viewRechargeReportsPagination">
								...
								{{currentPage+1}}/{{numberOfPages()}}
								<button ng-disabled="currentPage >= data.length/pageSize - 1" ng-click="currentPage=currentPage+1">Next</button>
								<button ng-click="getPanReportReportExcel(panReports);">EXPORT</button>
							</div> 
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive" ng-if="panReports.length <= 0">
								<table cellspacing="1" class="table table-striped table-bordered table-hover">
									<tbody>
					...
					<div class="row clearfix visibility" id="sdiv20">
						...
						<table id="mainTable" class="table table-striped">
									...
									<tbody>
										<tr dir-paginate="report in panCouponReports |filter:Searchname | itemsPerPage: rowlimit">
											<td style="font-size: 12px;">{{$index + 1}}</td>
											<td style="font-size: 12px;">{{report.usernm}}<br> ({{report.usermbl}})</td>
											<td style="font-size: 12px;">{{report.panuser_id}}</td>
						...
						<div data-ng-show="viewRechargeReportsPagination">
								...
								{{currentPage+1}}/{{numberOfPages()}}
								<button ng-disabled="currentPage >= data.length/pageSize - 1" ng-click="currentPage=currentPage+1">Next</button>
								<button ng-click="getPanReportReportExcel(panCouponReports);">EXPORT</button>
							</div>
						</div> 
								<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive" ng-if="panCouponReports.length <= 0">
								<table cellspacing="1" class="table table-striped table-bordered table-hover">
	...
	<div id="div39" class="row clearfix" style="display: none; margin: 0px;">
		...
		<!-------------- div43 ---------------------->
		<div id="div43" class="row clearfix" style="margin: 0px;">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="header">
						<h2>All Report </h2>
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-control-label">
								...
								<!-- <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2">
										...
										<div class="col-xs-4 col-sm-4 col-md-2 col-lg-2">
											<div class="widget2 widget3">
												<a onClick="showDiv('div105')" href="javascript:;" id="">
													<div class="stats-left ">
														<img src="assets/images/icicon.png" style="width: 30%; height: 50px;margin-top: 10%;">
								 ...
								 <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2">
									 ...
									 <div class="col-xs-4 col-sm-4 col-md-2 col-lg-2">
										<div class="widget2 widget3">
											<a onclick="showDiv('div108')" href="javascript:;" id="">
												<div class="stats-left ">
													<i class="fa  fa-podcast col-black"></i>
					...
					<div class="body">
						<form class="form-horizontal">
							...
							<div class="row clearfix">
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									...
									<button type="button" class="btn btn-primary m-t-15 waves-effect" onclick="showDiv('div43')">Back</button>
								</div>
							</div>	
						</form>
						...
						<div class="row clearfix" style="margin-top: 2%">
							...
							<div data-ng-show="viewEarningReportPagination">
								...
								{{currentPage+1}}/{{numberOfPages()}}
								<button ng-disabled="currentPage >= data.length/pageSize - 1" ng-click="currentPage=currentPage+1">Next</button>
								<button  ng-click="getEarningReportReportExcel(earningReportDetails);">Export</button>
							</div>							
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive" ng-if = "earningReportDetails.length <= 0">
								<table id="mainTable" class="table table-striped">
									<tbody>
					...
					<div class="body">
						<form class="form-horizontal">
							<div class="row clearfix">
								...
								<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
									<button type="button" class="btn btn-primary m-t-20 waves-effect" ng-click="getImpsReport(impsReport,'getImpsReportDetail')">submit</button>
									<button type="button" class="btn btn-primary m-t-20 waves-effect" onclick="showDiv('div43')">Back</button>
								</div>
							</div>
						...
						<div class="row clearfix" style="margin-top: 2%">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive" ng-if = "impsReports.length > 0">
								<table id="mainTable" class="table table-striped">
									...
									<tbody>
										<tr dir-paginate="report in impsReports |filter:Searchname | itemsPerPage: rowlimit">
											<td style="font-size: 12px;">{{$index + 1}}</td>
						 	...
						 	<div data-ng-show="viewRechargeReportsPagination">
								...
								{{currentPage+1}}/{{numberOfPages()}}
								<button ng-disabled="currentPage >= data.length/pageSize - 1" ng-click="currentPage=currentPage+1">Next</button> -->
								<button type="button" class="btn btn-primary" ng-click="getIMPSReportExcel(impsReports);" ng-if="impsReports.length > 0">Export</button>
							</div> 
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive" ng-if="impsReports.length <= 0">
								<table cellspacing="1" class="table table-striped table-bordered table-hover">
									<tbody>
						...
						<form class="form-horizontal ng-pristine ng-valid">
							...
							<div class="row clearfix">
								...
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
									<div class="form-group">
										<div class="form-line focused">
											<input type="text" class="form-control" id="dp49" placeholder="Enter End Date" ng-model="aepsReport.endDate" readonly="readonly">
										</div>
									</div>
								</div>
							</div>
							<div class="row clearfix">
								...
								<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
									<div class="col-md-offset-3">
										...
										<button type="button" class="btn btn-primary waves-effect" onclick="showDiv('div43')">Back</button>
										<button type="button" class="btn btn-primary" ng-click="getrblReportExcel(rblReport);" ng-if="rblReport.length > 0">Export</button>
									</div>
									<div class="col-md-4" style="margin-top: 20px">
												<input class="form-control" type="text" step="1"
													placeholder=" ENTER SEARCH PARTICULAR USER  " ng-model="Searchname4">
							...
							<div class="row clearfix">
								<div class="form-group">
									...
									<table id="mainTable" class="table table-striped" style="    margin-left: 1%;">
										...
										<tbody>
											<tr	ng-repeat="rblRepo in rblReport | filter:Searchname4"  >
											<td>{{$index + 1}}</td>	
											<td>{{rblRepo.username}}</td>
											<td>{{rblRepo.name}}</td>
											<td>{{rblRepo.mobile}}</td>
											...
											<td>{{rblRepo.Status}}</td>
											<td ng-if="rblRepo.processingCode=='011'">Balance Withdrawal</td>
											<td ng-if="rblRepo.processingCode=='210000'">Balance Deposit</td>
											<td ng-if="rblRepo.processingCode=='010'">Balance Enquiry</td>
 ...
 -->											<td>{{rblRepo.date}}</td>
						...
						<form class="form-horizontal ng-pristine ng-valid">
							...
							<div class="row clearfix">
								...
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
									<div class="form-group">
										<div class="form-line focused">
											<input type="text" class="form-control" id="dp51" placeholder="Enter End Date" ng-model="settleReport.endDate" readonly="readonly">
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
									<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
										<div class="form-group form-float"
											style="margin-left: 0px !important;">
											<div class="form-line">
												<select class="form-control" ng-model="settleReport.type" ng-init="settleReport.type='ALL'">
												<option value="ALL">ALL</option>
							...
							<div class="row clearfix">
								...
								<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
									<div class="col-md-offset-3">
										...
										<button type="button" class="btn btn-primary waves-effect" onclick="showDiv('div43')">Back</button>
										<button type="button" class="btn btn-primary" ng-click="getSettlementReportExcel(settlementreport);" ng-if="settlementreport.length > 0">Export</button>
									</div>
								</div>
							</div>
							<div class="row clearfix">
	...
	<!-- ------------------------------------- /IMPS Success -------------------------------------- -->
										...
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<table id="datatable1" class="table table-striped table-bordered">
                                                  <thead>
                                                       ...
                                                       <tr ng-if="servicetype!='YesBank AEPS' && servicetype!='DMR'">
                                                  ...
                                                  <tbody>
                                                      <tr ng-repeat="packch in MyPackageDetail">
                                                          ...
                                                          <td class="text-center">
														    ...
														    <td class="text-center" ng-if="packch.serviceProvider=='YesBank AEPS'||packch.serviceProvider=='DMR'">
						...
						<div class="body">
							<form class="form-horizontal">
								...
								<div class="row clearfix">
									...
									<div class="col-md-4">
									<input class="form-control" type="text" step="1"
										placeholder=" ENTER SEARCH PARTICULAR USER  " ng-model="Searchname3">
									</div>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 hscroll">
									<table class="table table-striped">
										...
										<tbody>
											<tr	ng-repeat="item in aepsuser | filter:Searchname3">
												<td style="font-size: 12px;">{{$index + 1}}</td>
			...
			<!-------------- div59 ---------------------->	
				...
				<!-------------- /div59 ---------------------->		
					...
					<div id="div107" class="row clearfix" style="display: none; margin: 0px;">
										...
										<div class="row clearfix">
											...
											<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
												<div class="col-md-offset-3">
													...
													<button type="button" class="btn btn-primary waves-effect" onclick="showDiv('div43')">Back</button>
													<button type="button" class="btn btn-primary" ng-click="getp2aimoneyReportsExcel(p2aimpsReports);" ng-if="p2aimpsReports.length > 0">Export</button>
												</div>
												<div class="col-md-4" style="margin-top: 20px">
												<input class="form-control" type="text" step="1"
													placeholder=" ENTER SEARCH PARTICULAR USER  " ng-model="Searchname8">
												</div>
										...
										<div class="row clearfix">
											<div class="form-group">
												...
												<table id="mainTable" class="table table-striped" style="    margin-left: 1%;">
													...
													<tbody>
														<tr	ng-repeat="report in p2aimpsReports | filter:Searchname8"  >
															...
															<td>{{$index + 1}}</td>
																			...
																			<td>{{report.status}}</td>
																			<%if(user.getRoleId()==1) {%>
																			<td><button class="edit-button"  ng-click="updatep2astatus(report,'SUCCESS');" ng-if = "report.status == 'PENDING'">Success</button></td>
																			<td><button class="edit-button"  ng-click="updatep2astatus(report,'FAILED');" ng-if = "report.status == 'PENDING'">Failed</button></td>
																			<%} %>
																			<!-- <td><button class="edit-button" data-toggle="modal" data-target="#modalP2ARemark" ng-click="getmodalImpsRemark(report,'SUCCESS');" ng-if = "report.status == 'PENDING'">Success</button></td>
																			<td><button class="edit-button" data-toggle="modal" data-target="#modalP2ARemark" ng-click="getmodalImpsRemark(report,'FAILED');" ng-if = "report.status == 'PENDING'">FAILED</button></td> -->
														</tr>
												</tbody>
											</table>
										</div>
						...
						<div id="modalP2ARemark" class="modal fade" role="dialog" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
		  <div class="modal-dialog">
		 <!-- Modal content-->
		    <div class="modal-content" style="width: 43%;left: 18%;">
		      <div class="modal-header">
		      ...
		      <div class="modal-footer">
						...
						<div id="div108" class="row clearfix" style="display: none; margin: 0px;">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="card">
								<div class="header">
								...
								<div class="body">
									<form class="form-horizontal ng-pristine ng-valid">
										<div class="row clearfix">
											<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
												<label for="email_address_2">Start Date</label>
												<input type="text" class="form-control" id="dp61" placeholder="Enter Start Date" ng-model="p2aReport.startDate" readonly="readonly">
											</div>
											<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
												<label for="email_address_2">End Date</label>
												<input type="text" class="form-control" id="dp62" placeholder="Enter End Date" ng-model="p2aReport.endDate" readonly="readonly">
											</div>
											<button type="button" class="btn btn-primary waves-effect" ng-click="getMicroATMReport(p2aReport);">Update</button>
											<button type="button" class="btn btn-primary waves-effect" onclick="showDiv('div43')">Back</button>
											<button type="button" class="btn btn-primary" ng-click="getp2microatmReportsExcel(microatmReports);" ng-if="microatmReports.length > 0">Export</button>
										</div>
										
										<div class="row clearfix">
											<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
												<input class="form-control" type="text" step="1"
													placeholder=" ENTER SEARCH PARTICULAR USER  " ng-model="Searchname14">
											</div>
										</div>
										<div class="row clearfix">
											<div class="form-group">
												...
												<table id="mainTable" class="table table-striped" style="    margin-left: 1%;">
													...
													<tbody>
														<tr	ng-repeat="report in microatmReports | filter:Searchname14"  >
		...
		<!-------------- Div36 ---------------------->
		<div id="div109" class="row clearfix" style="display: none; margin: 0px;">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="header">
					...
					<!-- 	<form class="form-horizontal">
						...
						<div class="row clearfix" style="margin-top: 2%">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive"  ng-if="bavkslist.length > 0">
								<table id="mainTable" class="table table-striped">
									<thead>
										<tr style="font-size: 13px; font-weight: bold;">
											<th class="success text-center">Sl. No</th>
											<th class="success text-center">USER</th>											
											<th class="success text-center">Email</th>
											<th class="success text-center">Bank</th>
											<th class="success text-center">Account</th>
											<th class="success text-center">IFSC</th>
											<th class="success text-center">STATUS</th>	
											<%if(user.getRoleId() == 1){ %>												
											<th class="success text-center">Action</th>
											<%} %>
									...
									<tbody>
										<tr ng-repeat="item in bavkslist">
											<td style="font-size: 15px; text-align: center;">{{$index + 1}}</td>
											<td style="font-size: 15px; text-align: center;">{{item.name}}({{item.mobile}})</td>											
											<td style="font-size: 15px; text-align: center;">{{item.email}}</td>
											<td style="font-size: 15px; text-align: center;">{{item.bank}}({{item.branch}})</td>
											<td style="font-size: 15px; text-align: center;">{{item.account}}</td>
											<td style="font-size: 15px; text-align: center;">{{item.ifsc}}	</td>
											<td style="font-size: 15px; text-align: center;">{{item.status}}</td>
											<%if(user.getRoleId() == 1){ %>		
											<td style="font-size: 15px; text-align: center;">
												<span >
													<button class="edit-button" ng-click = "updatebankt(item,'ACTIVE');" ng-if = "item.status == 'INACTIVE'">ACTIVE</button>
													<button class="delete-button" style="width: 95%;" ng-click = "updatebankt(item,'INACTIVE');" ng-if = "item.status == 'ACTIVE'">INACTIVE</button>
												</span>
											</td>
											<%} %>
										</tr>
