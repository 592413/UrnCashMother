						...
						<div class="row clearfix">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-lg-offset-3 col-md-offset-3 ">
								<center><div class="form-group form-float">
									<button type="button" class="btn btn-lg waves-effect" ng-click = "checkuserYesBank(remitter);">SUBMIT</button>
								</div></center>
							</div>
						</div>
					</div>
									...
									<div class="row clearfix">
										...
										<div class="col-md-12">
											<div class="col-lg-offset-6 col-md-offset-6 col-sm-offset-6 col-xs-offset-6">
												<button  type="button" class="btn btn-primary m-t-15 waves-effect" ng-click="yesBankRemitterRegister(remitter);">Submit</button>
											</div>
										</div>
									</div>
								</form>
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive" >
								...
								<form class="form-horizontal">
									<div class="row clearfix">
											...
											<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
												<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
													<div class="form-group">
														<div class="form-group form-float" style="margin-left: 6%">
															<div class="form-line">
																<input type="text" class="form-control" ng-model = "remDetails.REQUESTNO" readonly="readonly"/>
															</div>
														</div>
													</div>
												</div>
										...
										<div class="col-md-12">
											<div class="col-lg-offset-6 col-md-offset-6 col-sm-offset-6 col-xs-offset-6">
												<button  type="button" class="btn btn-primary m-t-15 waves-effect"  ng-click="remitterverify(remDetails)">Submit</button>
											</div>
										</div>
									</div>
								</form>
									...
									<thead>
										<tr style="font-size: 13px; font-weight: bold;">
											<th class="success text-center">REMITTER MOBILE NUMBER</th>
											 <th class="success text-center" >KYC STATUS</th>
										 <th class="success text-center" ng-if="remitterDetails.RESP_CODE==700">REMITTER VERIFY</th>											
											 
										</tr>
									</thead>
									<tbody>
										<tr>
											<td style="font-size: 15px; text-align: center;">{{remitterDetails.remitter}}</td>		
											<td style="font-size: 15px; text-align: center;">{{remitterDetails.SENDER_CUSTTYPE}}</td>																					
											 <td style="font-size: 15px; text-align: center;" ng-if="remitterDetails.RESP_CODE==700"><button ng-click="verifyremitter(remitterDetails);" class="btn ">VERIFY REMITTER</button></td> 
									...
									<table id="" class="table table-striped">
										...
										<tbody>
											<tr ng-repeat="benedetails in remitterbeneficiarylist">
												...
												<td style="font-size: 15px; text-align: center;">{{benedetails.bank}}</td>
												<td style="font-size: 15px; text-align: center;">{{benedetails.ifsc}}</td>
												<td style="font-size: 15px; text-align: center;"  ng-if="benedetails.otpverified!=true"><button class="btn" ng-click="yesBankValidateBeneficiary(benedetails);">Validate</button><br></td>
												<td style="font-size: 15px; text-align: center;" ng-if="benedetails.otpverified==true"><h5>Validated</h5><br></td>
												<td style="font-size: 15px; text-align: center;"><button class="btn" ng-click="deleteyesBankbene(benedetails);">Delete</button><br></td>
												<td style="font-size: 15px; text-align: center;"><button class="btn" ng-click="doopmePaymentdetails(benedetails,remitterDetails.limit,remitterDetails.SENDER_CUSTTYPE);">Payment</button><br><!-- <h5> Upto &#x20B9; 20,000/-</h5> --></td>
											</tr>
										</tbody>
									</table>
								</div>								
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive" >
								...
								<form class="form-horizontal">
									<div class="row clearfix">
										...
										<div class="col-md-12">
											<div class="col-lg-offset-6 col-md-offset-6 col-sm-offset-6 col-xs-offset-6">
												<button type="button" class="btn btn-primary m-t-15 waves-effect" ng-click = "yesBankNewBeneficiary(bene);">Submit</button>
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive" >
								...
								<form class="form-horizontal">
									<div class="row clearfix">
										...
										<div class="col-md-12">
											<div class="col-lg-offset-6 col-md-offset-6 col-sm-offset-6 col-xs-offset-6">
												<button type="button" ng-click="yesBankMoneytransfer(bundlepayDetails);" class="btn btn-primary m-t-15 waves-effect" >Submit</button>
...
<script src="assets/js/angular.min.js"></script>
	...
	<script src="assets/scripts/angular_yesbank.min.js?version=1.1.0"></script>
