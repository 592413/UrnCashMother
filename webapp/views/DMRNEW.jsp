						...
						<div class="row clearfix">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-lg-offset-3 col-md-offset-3 ">
								<center><div class="form-group form-float">
									<button type="button" class="btn btn-lg new_dmr_bt" ng-click = "checkuserEncorenew(remitter);">SUBMIT</button>
								</div></center>
							</div>
						</div>
					</div>
									...
									<table id="" class="table table-bordered table-hover">
										...
										<tbody>
											<tr ng-repeat="benedetails in remitterbeneficiarylist">
												...
												<td style="font-size: 15px; text-align: center;">{{benedetails.bene_mobile}}</td>
											 ...
											 <td style="font-size: 15px; text-align: center;"><button class="btn" ng-if="benedetails.verified==false" ng-click="ValidateBeneficiaryEncore(benedetails,remitterDetails.remitter);">Validate</button><br></td>
												...
												<div class="form-group">
													<div class="form-group from-bord form-float" style="margin-left: 15px;">
														...
														<div class="form-line pa-from">
															<input type="text" class="form-control" ng-model="bundlepayDetails.bene_mobile" id="" readonly="readonly"/>
														</div>
													</div>
												</div>
											</div>
...
<script src="assets/js/angular.min.js"></script>
	...
	<script src="assets/scripts/angular_encoreDmrNew.min.js?version=1.1.0"></script>
