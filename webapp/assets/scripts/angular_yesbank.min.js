...
//	$scope.popremark= {};
			...
			*/
				...
				// console.log(data2);
				 ...
				 //console.log(data2);
					 ...
					 InputXml = "<PidOptions ver=\"1.0\"><Opts fCount=\"1\" wadh=\"\" format=\"0\" pidVer=\"2.0\" timeout=\"20000\"  posh=\"LEFT_INDEX\" env=\"P\" /> </PidOptions>";
					 }else if(details=='MANTRA_PROTOBUF'){
					 InputXml = "<PidOptions ver=\"1.0\"> <Opts fCount=\"1\" fType=\"0\" iCount=\"0\" pCount=\"0\" format=\"0\" pidVer=\"2.0\" timeout=\"20000\" posh=\"UNKNOWN\" env=\"P\" wadh=\"\"/> <CustOpts><Param name=\"mantrakey\" value=\"\" /></CustOpts> </PidOptions>";	 
					 }else if(details=='MORPHO_PROTOBUF'){
					 InputXml = "<PidOptions ver=\"1.0\"><Opts fCount=\"1\" fType=\"0\" iCount=\"\" iType=\"\" pCount=\"\" pType=\"\" format=\"0\" pidVer=\"2.0\" timeout=\"10000\" otp=\"\" wadh=\"\" posh=\"\"/></PidOptions>";	 
					 }
				             ...
				             if (xhr.readyState == 4) {
				                 if (xhr.status == 200) {
				                	 ...
				                	 if(txt==0){
				                		 ...
				                		 if($("#withdrawDiv").val()=="" && $("#miniEnquiryDiv").val()==""){
				                			 $("#captureBal").show(); 
					                		 $("#errInfoBal").hide();
					                		 $("#captureWithdraw").hide(); 
					                		 $("#errInfoWithdraw").hide();
					                		 $("#capture").hide(); 
					                		 $("#errInfo").hide();
				                		 }else if($("#balEnquiryDiv").val()=="" && $("#miniEnquiryDiv").val()==""){
				                			 $("#captureWithdraw").show(); 
					                		 $("#errInfoWithdraw").hide();
					                		 $("#capture").hide(); 
					                		 $("#errInfo").hide();
					                		 $("#captureBal").hide(); 
    ...
    $scope.callDevice= function(details) {
	 ...
	 $scope.yesBankResponse={};
	 $scope.iciciBankTransaction = function(details){
		    var format = /[ !@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/;
	 		var format2 = /[0123456789]/;
	 		var format4 = /[A-Z]/;
	 		var format3 = /((^[0-9]+[a-z]+)|(^[a-z]+[0-9]+))+[0-9a-z]+$/i;
			...
			console.log(details);
	 		$scope.loader=true;
	 		 ...
	 		 if(details.iin === null || details.iin === undefined || details.iin === ""){
		  			$scope.loader=false;
		  			$scope.showAlert("danger","Please Select bank");
		  			return false;
		  		}
	 		...
	 		$http.post('encorepayaepsweb',details).success(function(data) {
	 			console.log(data);
	 			$scope.loader=false;
	 			if(data.status == "1"){
	 		    showDiv('div2');
	 			$scope.EncoreAEPSResponse=data.EncoreAEPSResponse;
	 			}else{
	 ...
	 $scope.iciciMinitransaction = function(details){
		    var format = /[ !@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/;
	 		var format2 = /[0123456789]/;
	 		var format4 = /[A-Z]/;
	 		var format3 = /((^[0-9]+[a-z]+)|(^[a-z]+[0-9]+))+[0-9a-z]+$/i;
			...
			console.log(details);
	 		...
	 		$http.post('ministatementicici',details).success(function(data) {
	 			console.log(data);
	 			$scope.loader=false;
	 			if(data.status == "1"){
	 		    showDiv('div103');
	 			$scope.MinistatementResponse=data.MinistatementResponse;
	 			}else{
	 ...
	 $scope.iciciaadharBankTransaction = function(details){
		    var format = /[ !@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/;
	 		var format2 = /[0123456789]/;
	 		var format4 = /[A-Z]/;
	 		var format3 = /((^[0-9]+[a-z]+)|(^[a-z]+[0-9]+))+[0-9a-z]+$/i;
			...
			console.log(details);
	 		...
	 		$http.post('encorepayaadharweb',details).success(function(data) {
	 			console.log(data);
	 			$scope.loader=false;
	 			if(data.status == "1"){
	 		    showDiv('div2');
	 ...
	 $scope.checkuserYesBank = function(details){
 		$scope.loader = true;
		...
		$http.post('checkuserYesBank', details).success(function(data) {
			console.log(data);
			$scope.loader = false; 
			if(data.status == "1"){
			    showDiv('div1');
		...
		$scope.yesBankRemitterRegister =function(details){
    		$scope.loader = true;
    		...
    		$http.post('yesBankRemitterRegister', details).success(function(data) {
    			console.log(data);
    			$scope.loader = false; 
    			if(data.status == "1"){
    				$scope.showAlert("success", data.message);
	 ...
	 $scope.yesBankValidateBeneficiary = function(details){
	 	
	 		$scope.loader = true;
	 		console.log(details);
	 		$http.post('yesBankValidateBeneficiary',details).success(function(data) {
	 			console.log(data);
	 			$scope.loader = false; 
	 			if(data.status == "1"){
	 				$scope.showAlert("success", data.message);
	 ...
	 $scope.remitterverify = function(details){
	 		$scope.loader = true;
	 		details.REQUESTNO=details.REQUESTNO.toString();
	 		console.log(details);
	 		$http.post('remitterverify',details).success(function(data) {
	 			console.log(data);
	 			$scope.loader = false; 
	 			if(data.status == "1"){
	 				$scope.showAlert("success", data.message);
	 ...
	 $scope.yesBankMoneytransfer = function(details){
		 details.id=details.id.toString();
 		console.log(details);
 		...
 		$http.post('yesBankMoneytransfer',details).success(function(data) {
 			$scope.loader = false;
 				if(data.status == "1"){
	    				$scope.showAlert("success", data.message);
	    				showDiv('div1');
	 ...
	 $scope.deleteyesBankbene = function(details){
 		$scope.loader = true;
 		 details.id=details.id.toString();
 		console.log(details);
 		$http.post('deleteyesBankbene',details).success(function(data) {
	 ...
	 $scope.yesBankNewBeneficiary = function(details){
 		$scope.loader = true;
 		console.log(details);
	...
	//	console.log(format.test(details.bene_name));
		...
		if(format.test(details.beneMobileNumber)){
 		...
 		$http.post('yesBankNewBeneficiary', details).success(function(data) {
 			console.log(data);
 			$scope.loader = false; 
 			if(data.status == "1"){
 				$scope.showAlert("success", data.message);
