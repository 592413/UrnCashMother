...
//	$scope.popremark= {};
    ...
    $scope.callDevice= function(details) {
	 ...
	 $scope.checkuserEncore = function(details){
 		$scope.loader = true;
		...
		$http.post('checkuserEncore', details).success(function(data) {
			console.log(data);
			$scope.loader = false; 
			if(data.status == "1"){
			    showDiv('div1');
	 ...
	 $scope.ValidateBeneficiaryEncore = function(details){
	 		...
	 		$scope.loader = true;
	 		console.log(details);
	 		$http.post('ValidateBeneficiaryEncore',details).success(function(data) {
	 			console.log(data);
	 			$scope.loader = false; 
	 			if(data.status == "1"){
	 				$scope.showAlert("success",data.message);
	 ...
	 $scope.remitterverify = function(details){
	 		...
	 		console.log(details);
	 		$http.post('remmiterRegisterEncore',details).success(function(data) {
	 			console.log(data);
	 			$scope.loader = false; 
	 			if(data.status == "1"){
	 				$scope.showAlert("success", data.message);
	 ...
	 $scope.impsMoneyTransferEncore = function(details){
 		...
 		$http.post('impsMoneyTransferEncore',details).success(function(data) {
 			$scope.loader = false;
 				if(data.status == "1"){
	    				$scope.showAlert("success", data.message);
	    				showDiv('div1');
	 ...
	 $scope.deleteBeneficiaryEncore = function(details){
 		$scope.loader = true;
 		 details.id=details.id.toString();
 		console.log(details);
 		$http.post('deleteBeneficiaryEncore',details).success(function(data) {
 			console.log(data)
 			$scope.loader = false;
 			if(data.status == "1"){
				$scope.showAlert("success",data.message);
	...
	//	console.log(format.test(details.bene_name));
		...
		if(format.test(details.beneMobileNumber)){
 		...
 		$http.post('addBeneficiaryEncore', details).success(function(data) {
 			console.log(data);
 			$scope.loader = false; 
 			if(data.status == "1"){
 				$scope.showAlert("success", data.message);
